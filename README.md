...
Binary Change Detection on EO/SAR Imagery This project implements a deep learning pipeline to detect changes between satellite imagery pairs. We used a Siamese-style CNN architecture to classify image pairs as either 'No-Change' or 'Change'.
Requirements
